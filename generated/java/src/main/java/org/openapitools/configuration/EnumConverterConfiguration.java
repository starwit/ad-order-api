...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.rejectionReasonConverter")
    Converter<String, RejectionReason> rejectionReasonConverter() {
        return new Converter<String, RejectionReason>() {
            @Override
            public RejectionReason convert(String source) {
                return RejectionReason.fromValue(source);
            }
        };
    }
